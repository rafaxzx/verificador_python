...
- Precisará funcionar no modo “janela” utilizando biblioteca de janelas **X** a ser definida
- Ter interface o mais simples possível e estável. Seguindo ideia de “*Click and Go. If it fails, show me why*.”

## Informações adicionais

- Serão duas fontes de dados. Um CLP *Siemens* *319F* e uma página web no seguinte endereço (`url dos mapas sem necessidade de autenticação`)
